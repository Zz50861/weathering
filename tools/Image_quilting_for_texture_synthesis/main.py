...
parser.add_argument("-i", "--image_path", type=str, default="image/tunnel.png", help="path of image you want to quilt")
parser.add_argument("-b", "--block_size", type=int, default=60, help="block size in pixels")
parser.add_argument("-o", "--overlap", type=int, default=1.0/4, help="overlap size in pixels (defaults to 1/6th of block size)")
parser.add_argument("-s", "--scale", type=float, default=20, help="Scaling w.r.t. to image size")
parser.add_argument("-n", "--num_outputs", type=int, default=1, help="number of output textures required")
parser.add_argument("-f", "--output_file", type=str, default="output_.png", help="output file name")
